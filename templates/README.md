...
3. Fill in PDA seed checks, account owner validation, CPI transfers, tests, and deployment-specific program IDs.
4. Run the relevant local checks before adding the copied folder to a workspace.
